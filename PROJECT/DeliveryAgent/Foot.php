 ...
 <footer>
    ...
    <!-- ALL JS FILES -->
    <script src="../Assets/Templates/Main/js/jquery-3.2.1.min.js"></script>
    ...
    <!-- ALL PLUGINS -->
    <script src="../Assets/Templates/Main/js/jquery.superslides.min.js"></script>
    <script src="../Assets/Templates/Main/js/bootstrap-select.js"></script>
    <script src="../Assets/Templates/Main/js/inewsticker.js"></script>
    <script src="../Assets/Templates/Main/js/bootsnav.js."></script>
    ...
    <script src="../Assets/Templates/Main/js/baguetteBox.min.js"></script>
