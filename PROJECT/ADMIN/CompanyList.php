...
if(isset($_GET['aid']))
	{
		$upsQry="update tbl_company set company_vstatus=1 where  company_id=".$_GET['aid'];
		if($con->query($upsQry))
		{ 
            ?>
            <script>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        ...
        .table-container {
            margin-top: 30px;
            max-width: 1000px; /* Average width */
            margin-left: auto;
            margin-right: auto;
        }
        .table th, .table td {
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="CompanyList.php?aid=<?php echo $row['company_id']; ?>" class="btn btn-success btn-sm mb-1">Accept</a>
                        <a href="CompanyList.php?rid=<?php echo $row['company_id']; ?>" class="btn btn-danger btn-sm">Reject</a>
                    </td>
                </tr>
                <?php
                }
